...
## 15. Ghi chú
Các biến ngoại sinh chỉ cung cấp thông tin hỗ trợ và không nhất thiết phải được dự báo. Khi thay dữ liệu ngoại sinh bằng giá trị 0 hoặc nhiễu ngẫu nhiên, hiệu quả chỉ giảm nhẹ. Ngược lại, khi lịch sử biến nội sinh bị mất, kết quả suy giảm nghiêm trọng. TimeXer cũng gặp khó khăn khi dự báo các giá trị đột biến trên bộ Traffic.
