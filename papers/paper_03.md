...
## 2. Vấn đề nghiên cứu
Các mô hình Transformer hiện tại chủ yếu sử dụng cửa sổ thời gian cố định. Điều này hạn chế khả năng nắm bắt các biến động thời gian ở nhiều tỷ lệ, từ biến động ngắn hạn đến xu hướng dài hạn. Các cơ chế attention cũng thường tập trung vào tương quan tạm thời của từng mẫu dữ liệu, vì vậy có thể bỏ qua cấu trúc quan hệ toàn cục tương đối ổn định giữa các cổ phiếu trên thị trường.
...
### 5.2. Thuật toán
MCMamba sử dụng kiến trúc Mamba để xử lý chuỗi thời gian dài với độ phức tạp tuyến tính, kết hợp cơ chế attention và một ma trận tương quan toàn cục được học trực tiếp từ dữ liệu. Hàm Mean Squared Error được sử dụng làm hàm mất mát:
\[
